	...
	<div class="container">
		<div id="menu08702_3">
			...
			<div class="tableBox">
				...
				<div class="textBox">
					<ckeditor v-model="boardData.contents" :config="editorConfig"></ckeditor>
				</div>
			</div>
			<div class="btnBox">
				<button @click="UpDateBoard()">등록하기</button>
...
<script>
	...
	export default {
		...
		created() {
			...
			this.getBoardContents(this.$route.params.seqNo);
