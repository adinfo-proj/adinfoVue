  ...
  <div class="landForm landBox" >
    ...
    <div class="upPage">
      <div class="formStyle category">
        <h6>폼 유형 선택</h6>
        <div class="flex">
          <input type="radio" :name="formStyle+this.indexNum"  v-model="formModel.formStyle" :id="'form01_'+this.indexNum" value="01">
          <label :for="'form01_'+this.indexNum">
            <img src="../../assets/images/menu08302/ex01.jpg" alt="">
          </label>
          <input type="radio" :name="formStyle+this.indexNum"  v-model="formModel.formStyle" :id="'form02_'+this.indexNum" value="02">
          <label :for="'form02_'+this.indexNum">
            <img src="../../assets/images/menu08302/ex02.jpg" alt="">
          </label>
          <input type="radio" :name="formStyle+this.indexNum"  v-model="formModel.formStyle" :id="'form03_'+this.indexNum" value="03">
          <label :for="'form03_'+this.indexNum">
            <img src="../../assets/images/menu08302/ex03.jpg" alt="">
          </label>
          <input type="radio" :name="formStyle+this.indexNum"  v-model="formModel.formStyle" :id="'form04_'+this.indexNum" value="04">
          <label :for="'form04_'+this.indexNum">
            <img src="../../assets/images/menu08302/ex04.jpg" alt="">
          </label>
        </div>
      </div>
      ...
      <div class="formStyle fontStyle">
        ...
        <div class="flex">
          <input type="radio" v-model="formModel.fontType" :name="fontType+this.indexNum" :id="'font01_'+this.indexNum" value="Nanum Gothic" class="nanum">
          <label :for="'font01_'+this.indexNum">
            나눔고딕
          </label>
          <input type="radio" v-model="formModel.fontType" :name="fontType+this.indexNum" :id="'font02_'+this.indexNum" value="TmonMonsori" class="tmon">
          <label :for="'font02_'+this.indexNum">
            티몬체
          </label>
          <input type="radio" v-model="formModel.fontType" :name="fontType+this.indexNum" :id="'font03_'+this.indexNum" value="BMJUA" class="jua">
          <label :for="'font03_'+this.indexNum">
            배민 주아체
          </label>
          <input type="radio" v-model="formModel.fontType" :name="fontType+this.indexNum" :id="'font04_'+this.indexNum" value="BMDOHYEON" class="dohyeon">
