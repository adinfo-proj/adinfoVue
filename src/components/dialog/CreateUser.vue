<template>
  <div id="singPopUp">
    ...
    <!-- <div class="adGradeBox">
      ...
      <input type="radio" name="adGradeCd" id="adGradeCd05" v-model="adGradeCd" value="05">
      <label for="adGradeCd05">
        <span>
    ...
    <div class="radioBox">
      <input type="radio" ref="termsYn" name="termsYn" id="termsY" v-model="termsYn" value="Y"><label for="termsY">동의합니다.</label>
      <input type="radio" name="termsYn" id="termsN" v-model="termsYn" value="N"><label for="termsN">동의하지 않습니다.</label>
    </div>
    <h3> 개인정보취급방침</h3>
    <div class="termsBox">
      <p>
        <b>디비마스터(DB Master) 개인정보취급방침</b><br>
        <br>
        <span>
          <b>(주)마케팅디자인</b> ('dbmaster.co.kr'이하 '디비마스터')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br>
          &nbsp; ○ 이 개인정보처리방침은 2022년 2월 14부터 적용됩니다.
          <br>
          <br>
          제1조(개인정보의 처리 목적) <b>(주)마케팅디자인</b> ('dbmaster.co.kr'이하 '디비마스터')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br>
          <span>
            1. 홈페이지 회원가입 및 관리<br>
          ...
          <span>
            1. <b>(주)마케팅디자인</b> 은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br>
          ...
          제3조(개인정보의 제3자 제공)<br>
          <span>
            1. <b>(주)마케팅디자인</b> 은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br>
            2. <b>(주)마케팅디자인</b> 은(는) 귀하의 개인정보를 "개인정보의 수집목적 및 이용목적"에서 고지한 범위 내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업·기관에 제공하지 않습니다. 다만, 다음의 경우에는 예외로 합니다.<br>
            <span>
          ...
          제4조(개인정보처리 위탁)<br>
          <span>
            1. <b>(주)마케팅디자인</b>은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br>
            <span>
              1) (주)모비윈 <br>
            ...
            <br>
            2. <b>(주)마케팅디자인</b> 은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br>
          ...
          <span>
            1. 정보주체는 <b>(주)마케팅디자인</b>에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br>
            2. 제1항에 따른 권리 행사는<b>(주)마케팅디자인</b>에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 <b>(주)마케팅디자인</b>은(는) 이에 대해 지체 없이 조치하겠습니다.<br>
            ...
            6. <b>(주)마케팅디자인</b>은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
          </span>
          <br>
          <br>
          제6조(처리하는 개인정보의 항목 작성)<br>
          <span>
            <b>(주)마케팅디자인</b> 은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br>
            <span>
              [ 홈페이지 회원가입 및 관리 ]<br>
          ...
          <span>
            ...
            SNS계정(페이스북,네이버,카카오)을 통한 로그인또한 내정보->회원탈퇴에서 이용이 가능하며 SNS제공업체에서 연동을 해제 할수 있습니다. 그러나 SNS 연동해제를 하더라도 '디비마스터'에 보관중인 고객정보가 삭제되는 것은 아니므로 회원탈퇴를 진행하셔야 개인정보가 파기됩니다.<br>
            <br>
            <span>
              1. <b>(주)마케팅디자인</b> 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br>
              ...
              <span>
                1) 파기절차<br>
                <b>(주)마케팅디자인</b> 은(는) 파기 사유가 발생한 개인정보를 선정하고, <b>(주)마케팅디자인</b> 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br>
                2) 파기방법<br>
          ...
          <span>
            <b>(주)마케팅디자인</b> 은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br>
            <span>
              1. 정기적인 자체 감사 실시<br>
              ...
              &nbsp; <b>(주)마케팅디자인</b>('디비마스터')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된<br>
          ...
          <span>
            1. <b>(주)마케팅디자인</b> 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br>
          ...
          제10조 (개인정보 보호책임자)<br>
          <span>
            <b>(주)마케팅디자인</b> 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br>
            <span>
            ▶ 개인정보 보호책임자<br>
            성명 :유기옥<br>
            직책 :대표<br>
            대표전화 :1533-3757, 이메일: pnb@pnbmarketing.com, 팩스: 02-2668-0633<br>
            </span>
            ※ 개인정보 보호 담당부서로 연결됩니다.<br>
            <b>(주)마케팅디자인</b> 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. <b>(주)마케팅디자인</b> 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
          </span>
          <br>
          <br>
          제11조(개인정보 열람청구)<br>
          <span>
            ...
            <b>(주)마케팅디자인</b>은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br>
            <span>
              ▶ 개인정보 열람청구 접수·처리 부서<br>
              성명 :유기옥<br>
              직책 :대표<br>
              대표전화 :1533-3757, 이메일: pnb@pnbmarketing.com, 팩스: 02-2668-0633
            </span>
          </span>
          <br>
          <br>
    ...
    <div class="radioBox">
      <input type="radio" ref="policyYn" name="policyYn" id="policyY" v-model="policyYn" value="Y"><label for="policyY">동의합니다.</label>
    ...
    <div class="tableBox">
      <table>
        <tr>
          <th>이메일(아이디)</th>
          <td class="tableWi">
            <input type="text" placeholder="abc@abd.co.kr" v-model="emailId" ref="emailId">
          </td>
          <th>이름/회사명</th>
          <td>
            <input type="text" class="wMax" v-model="userName" ref="userName">
          </td>
        </tr>
        <tr>
          <th>비밀번호</th>
        ...
        <tr>
          <th>비밀번호 확인</th>
          <td colspan="3">
            <input type="password" name="userPwCon" id="userPwCon" v-model="userPassConf" ref="userPassConf">
